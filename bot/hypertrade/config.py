...
class Settings(BaseSettings):
    ...
    # on (opens blocked, exits keep running). Every boot also checks the
    # DB against the exchange's fills; a stale DB gets the kill switch
    # and a pause, and the alert repeats every this many minutes for as
    ...
    # coin is not traded by any strategy in this bot. A held position
    # stays held until it is flat or has a DB row again.
